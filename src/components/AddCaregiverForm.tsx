...
export default function AddCaregiverForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) throw new Error(data.error ?? "Could not add caregiver.");
  ...
  return (
    ...
    >
      <p className="text-sm text-muted">
        Caregivers (grandparents, sitters) can approve completions and requests, adjust
        points, and undo a mistaken entry -- but can&apos;t manage tasks, rewards, kids, or
        settings.
      </p>
      <input
        type="text"
